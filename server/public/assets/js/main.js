(function($, Window, WebUploader) {
  ...
  function getServer(type) {
    ...
    switch (type) {
      ...
      case "java":
        return "http://localhost:8080/fileUpload";
      case "dubbo":
        return "http://127.0.0.1:8888/fileUpload";
    }
  }

  var backEndUrl = getServer("node");
  ...
  uploader.on("fileQueued", function(file) {
    $("#theList").append(
      '<li id="' +
        ...
        "<img /><span>" +
        file.name +
        '</span><span class="itemUpload">上传</span><span class="itemStop">暂停</span><span class="itemDel">删除</span>' +
